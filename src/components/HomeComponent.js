    ...
    <div className="container">
      <div className="row align-items-start">
        <div className="col-12 col-md m-1">
          ...
          {/* <RenderCard item={props.promotion} isLoading={props.promoLoading} errMess={props.promoErrMess} />      // Use this line instead if you have a valid NODE API to fetch data. */}
        </div>
        <div className="col-12 col-md m-1">
